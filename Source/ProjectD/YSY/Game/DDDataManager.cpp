...
UDDDataManager::UDDDataManager()
{
	...
	LoadDataTable<FDDTrapData>(TrapDataTable, TEXT("/Script/Engine.DataTable'/Game/0000/LSM/Data/LSM_DT_Trap_Merged.LSM_DT_Trap_Merged'"));
	LoadDataTable<FDDTowerData>(TowerDataTable, TEXT("/Script/Engine.DataTable'/Game/0000/LSM/Data/LSM_DT_Tower_Merged.LSM_DT_Tower_Merged'"));
